...
import { ArrowRightIcon, CalendarIcon, ScanFaceIcon, SearchIcon, WaypointsIcon } from "lucide-react";
...
export const CARDS = [
    {
        ...
        description: "Detect who is speaking and track their face.",
        href: "#",
        cta: "Learn more",
    ...
    {
        Icon: SearchIcon,
        name: "Clip from a Prompt",
        description: "Clip any moment from any video using a prompt.",
        href: "#",
        cta: "Learn more",
        ...
        background: (
            <Command className="absolute right-10 top-10 w-[70%] origin-to translate-x-0 border border-border transition-all duration-300 ease-out [mask-image:linear-gradient(to_top,transparent_40%,#000_100%)] group-hover:-translate-x-10 p-2">
                <Input placeholder="The part..." />
                <div className="mt-1 cursor-pointer">
                    <div className="px-4 py-2 hover:bg-muted rounded-md">The part where I eat shawarma</div>
                    <div className="px-4 py-2 hover:bg-muted rounded-md">The part where Mr. Beast gets roasted</div>
                    <div className="px-4 py-2 hover:bg-muted rounded-md">The part most likely to go viral</div>
                    <div className="px-4 py-2 hover:bg-muted rounded-md">The part when Elon mentions Mars.</div>
                </div>
            </Command>
        ),
    },
    ...
    },
    {
        ...
        description: "Schedule uploads to YouTube seamlessly.",
        className: "col-span-3 lg:col-span-1",
        href: "#",
        cta: "Learn more",
        background: (
