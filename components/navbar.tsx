...
const Navbar = () => {
    ...
    const isActiveLink = (linkTitle: string) => {
        if (linkTitle === 'Features' && pathname.startsWith('/features')) return true;
        if (linkTitle === 'Pricing' && pathname === '/pricing') return true;
        if (linkTitle === 'Enterprise' && pathname === '/enterprise') return true;
        if (linkTitle === 'Resources' && pathname.startsWith('/resources')) return true;
        if (linkTitle === 'Changelog' && pathname === '/changelog') return true;
        return false;
    };
                                        ...
                                        {link.menu ? (
                                            <>
                                                <NavigationMenuTrigger className={cn(
                                                    isActiveLink(link.title) && 'text-white'
                                                )}>
                                                    {link.title}
                                                </NavigationMenuTrigger>
                                                <NavigationMenuContent>
                    ...
                    <div className="hidden lg:flex items-center">
                        {user ? (
                            <div className="flex items-center">
                                <Link href="/dashboard" className={cn(buttonVariants({ size: "sm", }), "mr-5")}>
                                    Dashboard
                                </Link>
                                <UserButton />
                            </div>
